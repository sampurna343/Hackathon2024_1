...
st.header("Image Processing of Chest X-Ray templates for Chest Disease prediction")

st.image("https://sumas.edu.ng/wp-content/uploads/2023/02/skeleton-bg.jpg")
